<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="program.aspx.cs" Inherits="RoskildeDampradio.program" %>
        ...
        <div id="second_colon_content">
            ...
            <div id="program_kalender">
                ...
                <div class="color-box">
                    ...
                    <span>Valgte dato</span>
                </div>
            </div>
            <div id="program_dag">
                <hr />
                <h2><asp:Label ID="Label_program_dag" runat="server"></asp:Label></h2>
                <asp:Repeater ID="Repeater_program_dag" runat="server">
                    <HeaderTemplate><div class="program_dag"></HeaderTemplate>
                    <ItemTemplate>
                        <h3><%# Eval("titel") %></h3> Kl. <%# Convert.ToDateTime(Eval("start")).ToShortTimeString() %>
                        <%# Eval("info") %><br />
